...
import static com.example.rohit.arishit_f.group_view.group_add_member.checked_contact_add;

public class group_add_member_adapter extends ArrayAdapter<group_create_contact> {

    public group_add_member_adapter(Activity context, ArrayList<group_create_contact> wordGroup){
