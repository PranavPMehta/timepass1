package com.example.rohit.arishit_f.voiceCall;
...
public class SinchService extends Service {
    ...
    */
    ...
    private static final String APP_KEY = "76f22907-358f-4a4d-b2df-ffe09f440928";
    private static final String APP_SECRET = "SnvpqN9FvEa6JD/LxCcG/g==";
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public void startClient(String userName) {
            start(userName);
            System.out.println("Started "+mUserId);
        }
