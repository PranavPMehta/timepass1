...
public class TextEditorDialogFragment extends DialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public static int mTextSize = 50;
    ...
    public static TextEditorDialogFragment show(@NonNull EditImageActivity appCompatActivity) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.presentation_add_text_dialog, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("Edit  Testsize" , String.valueOf(mTextSize));
