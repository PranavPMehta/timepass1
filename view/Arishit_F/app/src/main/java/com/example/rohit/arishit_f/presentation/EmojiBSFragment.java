...
import com.example.rohit.arishit_f.presentation.lib.PhotoEditor;
...
public class EmojiBSFragment extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.presentation_fragment_bottom_sticker_emoji_dialog, null);
    ...
    public class EmojiAdapter extends RecyclerView.Adapter<EmojiAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.presentation_row_emoji, parent, false);
